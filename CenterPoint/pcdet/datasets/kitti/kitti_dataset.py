...
class KittiDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.num_ftrs = self.dataset_cfg.DATA_AUGMENTOR.AUG_CONFIG_LIST[0].NUM_POINT_FEATURES
    ...
    def get_infos(self, num_workers=4, has_label=True, count_inside_pts=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            info = {}
            pc_info = {'num_features': self.num_ftrs, 'lidar_idx': sample_idx}
    ...
    def generate_prediction_dicts(batch_dict, pred_dicts, class_names, output_path=None):
        ...
        def generate_single_sample_dict(batch_index, box_dict):
            ...
            pred_dict['dimensions'] = pred_boxes_camera[:, 3:6] # l,h,w
            pred_dict['location'] = pred_boxes_camera[:, 0:3] # x,y,z
            pred_dict['rotation_y'] = pred_boxes_camera[:, 6] #r
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path=ROOT_DIR / 'data' / 'kitti_prm',
            save_path=ROOT_DIR / 'data' / 'kitti_prm'
        )
