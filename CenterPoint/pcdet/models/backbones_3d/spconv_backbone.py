...
class VoxelBackBone8x(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        self.conv_input_prm = spconv.SparseSequential(
    ...
    def forward(self, batch_dict):
        ...
        voxel_prm = batch_dict['voxels_prm'] # Nx4
        voxel_features, voxel_coords = batch_dict['voxel_features'], batch_dict['voxel_coords'] # Nx3
        batch_size = batch_dict['batch_size']
        assert voxel_prm.shape[0] == voxel_features.shape[0], (voxel_prm.shape[0], voxel_features.shape[0])    
        
        input_prm_tensor = spconv.SparseConvTensor(
            features=voxel_prm,
