...
from secondpy.protos import target_pb2, anchors_pb2
from secondpy.builder import similarity_calculator_builder
from secondpy.builder import anchor_generator_builder
